...
import org.firebrand.dao.*;
import org.firebrand.dao.events.ColumnEventListener;
import org.firebrand.dao.events.EntityEventListener;
...
// --------------------- Interface PersistenceFactory ---------------------
     ...
     *
     * @see org.firebrand.dao.AbstractPersistenceFactory#destroy()
     */
    public void destroy() {
        if (isDropOnDestroy()) {
